...
import static com.example.notekeeper.Note.SQLiteDatabase.NoteKeeperDatabaseContract.*;
import static com.example.notekeeper.Note.ContentProvider.NoteKeeperProviderContract.*;
...
public class NoteKeeperContentProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(AUTHORITY, Notes.PATH_EXTENDED, NOTES_EXPANDED);
        sUriMatcher.addURI(AUTHORITY, Courses.PATH + "/#", COURSES_ROW);
        sUriMatcher.addURI(AUTHORITY,Notes.PATH + "/#", NOTES_ROW);
        sUriMatcher.addURI(AUTHORITY, Notes.PATH_EXTENDED + "/#", NOTES_EXPANDED_ROW);
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (uriMatcher) {
            case COURSES:
                // vnd.android.dir/vnd.com.example.notekeeper.provider.courses
            ...
            case NOTES_EXPANDED:
                mimeType = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" +
                        MIME_VENDOR_TYPE + Notes.PATH_EXTENDED;
                break;
            case COURSES_ROW:
    ...
    private Cursor notesExpandedQuery(SQLiteDatabase db, String[] projection, String selection,
        ...
        String joinTable = NoteInfoEntry.TABLE_NAME + " JOIN " +
                CourseInfoEntry.TABLE_NAME + " ON " +
                NoteInfoEntry.getQName(NoteInfoEntry.COLUMN_COURSE_ID) + " = " +
                CourseInfoEntry.getQName(CourseInfoEntry.COLUMN_COURSE_ID);


        return db.query (joinTable, columns, selection, selectionArgs, null,
                null, sortOrder);
    }
