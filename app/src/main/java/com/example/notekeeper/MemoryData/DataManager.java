package com.example.notekeeper.MemoryData;
...
public class DataManager {
    ...
    private static final ExecutorService mExecutorsSingleThread = Executors.newSingleThreadExecutor();
 ...
 */       }
    ...
    public static void loadFromDatabase(NoteKeeperOpenHelper dbHelper) {
        ...
        /*mExecutorsSingleThread.execute(new Runnable() {
            @Override
            public void run() {
    ...
    public int createNewNote(CourseInfo course, String title, String noteText) {
