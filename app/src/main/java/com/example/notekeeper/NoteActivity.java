...
import static com.example.notekeeper.Note.SQLiteDatabase.NoteKeeperDatabaseContract.NoteInfoEntry;
...
import com.example.notekeeper.CustomView.ModuleStatusView;
...
import com.example.notekeeper.Note.SQLiteDatabase.NoteKeeperDatabaseContract.CourseInfoEntry;
import com.example.notekeeper.Note.SQLiteDatabase.NoteKeeperOpenHelper;
import com.example.notekeeper.Note.ContentProvider.NoteKeeperProviderContract.Courses;
import com.example.notekeeper.Note.ContentProvider.NoteKeeperProviderContract.Notes;
import com.example.notekeeper.Note.NoteReminderNotification;
...
public class NoteActivity extends AppCompatActivity
    ...
    private void loadModuleStatusValues() {
        ...
        for (int moduleIndex = 0; moduleIndex < completeNumberOfModules; moduleIndex++)
    ...
    private void createEmptyNewNote() {
        ContentValues values = new ContentValues();
        values.put(Notes.COLUMN_COURSE_ID, "");
        values.put(Notes.COLUMN_NOTE_TITLE, "");
        values.put(Notes.COLUMN_NOTE_TEXT, "");

        Runnable runnable = () -> mNoteUri = getContentResolver().insert(Notes.CONTENT_URI, values);
        Thread thread = new Thread(runnable);
        thread.start();
